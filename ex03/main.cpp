...
/*   Updated: 2026/01/25 12:46:58 by maballet         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    ...
    delete poly;
	    ...
	    std::cout << std::endl;
    std::cout << GREYBG << "===== DIAMONDTRAP CONSTRUCTION TEST =====" << STANDARD << std::endl << std::endl;

    DiamondTrap diamond("DIAMY");

    std::cout << std::endl;
    std::cout << GREYBG << "===== DIAMONDTRAP ATTACK TEST =====" << STANDARD << std::endl << std::endl;

    diamond.attack("shiny target");

    std::cout << std::endl;
    std::cout << GREYBG << "===== DIAMONDTRAP WHOAMI TEST =====" << STANDARD << std::endl << std::endl;

    diamond.whoAmI();

    std::cout << std::endl;
    std::cout << GREYBG << "===== DIAMONDTRAP POLYMORPHISM TEST =====" << STANDARD << std::endl << std::endl;

    ClapTrap* polyDiamond = new DiamondTrap("POLY_DIAMOND");
    polyDiamond->attack("polymorphic diamond");
    delete polyDiamond;
